...
一个**零依赖、纯前端、程序化生成**的第一人称射击游戏（当前版本 **v11.3**）。双击 `index.html` 即可游玩 —— 无服务器、无构建、无安装。过关模式（5 关）+ 无尽模式，墙体掩体结构、全场景可破坏、猪头佳/机甲 BOSS/霸王龙三大 BOSS 战。
...
- 🔫 **6 种武器**（枪模程序化圆润写实重建，数值均为当前 v11.3 版本）：
...
- 🌳 **程序化场景**：建筑、车辆、集装箱、飞机、大树、高墙、摩天轮、蘑菇、草地花丛、2 种飞鸟、**可攀爬瞭望塔**随机分布
