...
(function (global) {
  ...
  global.MODELS.bigtree = {
    ...
    create: function (config) {
      ...
      const trunkMat = new window.MARIO.matS({ color: 0x5d4030});
      const branchMat = new window.MARIO.matS({ color: 0x4e342e});
      const leafMat = new window.MARIO.matS({ color: 0x2e7d32});
      const leafMat2 = new window.MARIO.matS({ color: 0x388e3c});
