...
(function (global) {
  ...
  global.MODELS.chest = {
    ...
    create: function () {
      ...
      const woodMat = new window.MARIO.matS({ color: 0x6b4a2b});
      const goldMat = new window.MARIO.matS({
        color: 0xf1c40f,
        emissive: 0x7a5c00, emissiveIntensity: 0.5
      });
      const glowMat = new window.MARIO.basicS({
      ...
      const core = new T.Mesh(
        ...
        new window.MARIO.basicS({ color: 0xffe680 })
      );
