...
(function (global) {
  ...
  global.MODELS.coconut = {
    ...
    create: function (config) {
      ...
      const trunkMat = new T.MeshLambertMaterial({ color: 0x8a6a4a, flatShading: true });
      const trunkDark = new T.MeshLambertMaterial({ color: 0x6e533a, flatShading: true });
      const leafMat = new T.MeshLambertMaterial({ color: 0x3a9d4a, flatShading: true });
      const leafLight = new T.MeshLambertMaterial({ color: 0x4cb55a, flatShading: true });
      const coconutMat = new T.MeshLambertMaterial({ color: 0x5a3d24, flatShading: true });
