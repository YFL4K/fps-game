...
(function (global) {
  ...
  global.MODELS.spawner = {
    ...
    create: function () {
      ...
      const ringMat = new window.MARIO.basic({ color: 0xaa55ff, transparent: true, opacity: 0.9 });
      ...
      const inner = new T.Mesh(
        ...
        new window.MARIO.basic({ color: 0xff66cc, transparent: true, opacity: 0.8 })
      );
