...
(function (global) {
  ...
  global.MODELS.pickup = {
    ...
    create: function (config) {
      ...
      // 十字标记
      const markMat = new window.MARIO.matS({ color: 0xffffff, emissive: 0xffffff, emissiveIntensity: 0.8 });
      ...
      const ring = new T.Mesh(
        ...
        new window.MARIO.basicS({ color: isFlame ? 0xff8844 : (kind === 'health' ? 0x7dffc0 : 0xffe08a) })
      );
