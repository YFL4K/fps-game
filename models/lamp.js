  ...
  global.MODELS.lamp = {
    ...
    create: function () {
      ...
      const pole = new T.Mesh(
        ...
        new window.MARIO.matS({ color: 0x4a4f58})
      );
      pole.position.y = 1.5;
      ...
      const base = new T.Mesh(
        ...
        new window.MARIO.matS({ color: 0x33373f})
      );
      base.position.y = 0.05;
      g.add(base);

      // 灯头
      const lampMat = new window.MARIO.matS({
        color: 0xfff2c8,
        emissive: 0xffdd88,
      ...
      const shade = new T.Mesh(
        ...
        new window.MARIO.matS({ color: 0x5a5f68, side: T.DoubleSide })
      );
